...
from utils import current_time, generate_id

class DBProvider:
    def __init__(self, user, passwd, host='localhost', database='trackify'):
    ...
    def add_user(self, user_id, username, password, email, time_added):
        sef..execute('INSERT INTO users (id, username, password, email, time_added)
    ...
    def add_album(self, album_id, name, album_type, release_date, release_date_precision):
        self.execute('INSERT INTO albums (id, album_name, album_type, release_date,
                     ...
                     VALUES (?, ?, ?, ?, ?)', (album_id, name, album_type, release_date,
                                            release_date_precision,))
